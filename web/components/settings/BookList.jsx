import { Paper, Button, Checkbox, SelectField } from 'react-md';
...
export default class BookListSettings extends React.Component {
  constructor(props) {
    ...
    this.columns = ['Title', 'Creators', 'Added', 'Published', 'Publisher'];
  }
  ...
  onSaveTable() {
    ...
    this.columns.forEach(col => {
      if (window[`checkbox--${col}`].checked) columns.push(col.toLowerCase());
    });
  ...
  render() {
    ...
    return (
      <div className="book-list-settings">
        <Paper zDepth={1} component="section" className="table section">
          <h2>Table</h2>
          ...
          >
            ...
            <SelectField
              ...
              label="Column"
              menuItems={this.columns.map(col =>
